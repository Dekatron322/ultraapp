...
export default function HeroSection({ mounted, currentTheme }: HeroSectionProps) {
  ...
  return (
    ...
    >
      ...
      <div className="large-text relative z-10 mx-auto mt-10 flex w-full max-w-6xl flex-col items-center justify-center text-center max-md:py-16 max-sm:px-4 md:my-44 md:px-10">
        <motion.div
