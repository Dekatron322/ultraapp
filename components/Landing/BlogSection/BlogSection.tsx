...
const BlogSection = ({ currentTheme }: BlogSectionProps) => {
  ...
  const getSampleBlogs = (): Blog[] => [
    ...
    {
      id: "2",
      title: "Understanding Next-Gen Payment Systems for Modern Business",
      category: "Payments",
      author: "Mike Chen",
      date: "2024-01-12",
      readTime: "8 min read",
      description:
        "Deep dive into real-time payment technology and modern cross-border financial rails for global businesses.",
      image: "/blog/blog1.png",
