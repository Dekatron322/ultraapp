...
export default function HeroSection({ mounted, currentTheme }: HeroSectionProps) {
  ...
  const fullText = "Getting started with UltraApp"
  ...
  return (
    <motion.div
      className="relative flex w-full  flex-col items-center justify-center overflow-hidden bg-cover bg-center bg-no-repeat max-md:pt-16"
      style={{
    ...
    >
      ...
      <div className="large-text relative z-10 mx-auto mt-10 flex w-full flex-col items-center justify-center text-center max-md:px-4 md:mt-48 md:max-w-6xl md:px-10">
        <motion.div
        ...
        <motion.p
          className="small-text mt-6 text-base md:max-w-2xl md:text-xl"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.4 }}
        >
          Transform Your Financial Management with Automation and Real-Time Insights
        </motion.p>
...
function HeroImages() {
  return (
    <motion.div
      className="z-10 mt-auto flex items-center justify-between px-4 md:w-[1240px] md:gap-10"
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
    ...
    >
      <div>
        <motion.img
          src="/user.svg"
          alt="decorative line"
          className="mb-20 max-w-full max-md:w-[100px] md:w-[336px]"
      ...
      <motion.img
        src="/img4.png"
        alt="decorative line"
        className="max-w-full max-md:w-[100px] md:w-[336px]"
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-full max-w-md rounded-xl bg-white p-8 shadow-2xl dark:bg-gray-900 max-md:max-w-[350px]"
        onClick={(e) => e.stopPropagation()}
      >
        <button
          onClick={onClose}
          className="absolute flex size-8 items-center justify-center rounded-full p-1 text-gray-400 transition-all hover:bg-gray-100 hover:text-gray-600 dark:hover:bg-gray-800 max-md:right-2 max-md:top-2 md:right-6 md:top-6"
        >
          ×
        </button>
            ...
            <div className="text-center">
              <div className="mx-auto mb-4 flex size-48 items-center justify-center">
                <Image
                  ...
                  width={192}
                  height={192}
                  className="max-md:h-38 max-md:w-38 h-full  w-full object-contain"
                  onError={(e) => {
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 ">Scan with your phone camera</p>
            </div>
          </div>
